...
export default function IntroScreen({
  selectedTeamIndex, selectedDate, currentWeek, loading, onChangeTeam, onEnter,
}: IntroScreenProps) {
      ...
      <div className="intro-badge">
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0.7em' }}>
          ...
          <div style={{ textAlign: 'center', flex: 1 }}>
            <div style={{ fontSize: '0.72em', fontWeight: 700, letterSpacing: '0.16em', color: 'var(--yellow)', textTransform: 'uppercase' as const }}>
              YOUR TEAM
            </div>
            <div style={{ fontSize: '0.85em', fontWeight: 900, color: 'var(--white-smoke)', textTransform: 'uppercase' as const, letterSpacing: '0.06em' }}>
        ...
        >
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round">
            <path d="M12 2v8" /><path d="M16.24 5.76a8 8 0 1 1-8.48 0" />
          </svg>
